...
#### For programmers FYI, it's just a pyinstaller --onefile of BookBuilder.py. If you have a Windows machine, consider sharing the latest version as an application for Windows users.
